...
//		let _nodeID = nodeID;
	...
	_msg_SensorOptions(msg, stNode, options) {
		...
		try {
		  ...
		  console.log('<EEE> NodesNetManager._msg_SensorOptions ERROR');	// TODO REMOVE DEBUG LOG
	...
	_msg_SensorOptionsUpdated(msg, stNode, options) {
		...
		try {
			...
			controlSocket.emit(smngr.CONSTANTS.Messages.getSensorOptions, { "sensorID" : sensorID });	// Emit message getSensorOptions
		  ...
		  console.log('<EEE> NodesNetManager._msg_SensorOptionsUpdated ERROR');	// TODO REMOVE DEBUG LOG
		  console.log(response);	// TODO REMOVE DEBUG LOG
		}
