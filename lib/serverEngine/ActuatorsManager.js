	...
	addActuator(config) {
	  ...
	  // Event ActuatorStarted
		stActuator.eventEmitter.on(ActuatorsManager_CONSTANTS.Events.ActuatorStarted, function() {
			...
			console.log('<···> ST ActuatorsManager.ActuatorStarted');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> ' + stActuator.config.id );	// TODO OC REMOVE DEBUG LOG
	  ...
	  // Event ActuatorStopped
		stActuator.eventEmitter.on(ActuatorsManager_CONSTANTS.Events.ActuatorStopped, function() {
			...
			console.log('<···> ST ActuatorsManager.ActuatorStopped');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> ' + stActuator.config.id );	// TODO OC REMOVE DEBUG LOG
...
//		let _nodeID = nodeID;
		...
		console.log('<*> ST ActuatorsManager.turnOffActuatorsOfNode');	// TODO OC REMOVE DEBUG LOG
		console.log(nodeID);	// TODO OC REMOVE DEBUG LOG

		let actuatorsSearch = amngr.getActuatorsByNode(nodeID);
		
		if (actuatorsSearch.actuators != null) {
			console.log(' <·> Emit message');	// TODO OC REMOVE DEBUG LOG
			actuatorsSearch.actuators[0].config._controlSocket.emit(amngr.CONSTANTS.Messages.TurnOffActuators);
		} else {
			console.log(' <·> Node not found!!!');	// TODO OC REMOVE DEBUG LOG
		}
