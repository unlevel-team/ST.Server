...
class STServer {
	...
	loadConfig() {
		...
		if (this.serverConfiguration.config == null) {
			...
			console.log('Error in configuration');	// TODO OC REMOVE DEBUG LOG
			
			process.exit(0);
//			return -1;
			
		}
		console.log('<···> ST Server');	// TODO OC REMOVE DEBUG LOG
		console.log(' <···> ServerConfiguration');	// TODO OC REMOVE DEBUG LOG
		console.log(this.serverConfiguration.config);	// TODO OC REMOVE DEBUG LOG
	...
	init_NodesManager() {
		...
		this.nodesManager.eventEmitter.on(this.nodesManager.CONSTANTS.Events.NodeAdded, function(data){
			console.log('<···> ST Server.nodesManager');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Events.NodeAdded');	// TODO OC REMOVE DEBUG LOG
		...
		this.nodesManager.eventEmitter.on(this.nodesManager.CONSTANTS.Events.NodeRemoved, function(data){
			console.log('<···> ST Server.nodesManager');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Events.NodeRemoved');	// TODO OC REMOVE DEBUG LOG
	...
	init_NodesControlService() {
		...
		this.nodesControlService.eventEmitter.on(this.nodesControlService.CONSTANTS.Events.ConfigError, function(data){
			console.log('EEE> ST Server.ConfigError');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Configuration error.');	// TODO OC REMOVE DEBUG LOG
			stServer._byebye();
		});

		this.nodesControlService.eventEmitter.on(this.nodesControlService.CONSTANTS.Events.ServerListening, function(data){
			console.log('<···> ST Server.nodesControlService');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Server Listening');	// TODO OC REMOVE DEBUG LOG

		});

		this.nodesControlService.eventEmitter.on(this.nodesControlService.CONSTANTS.Events.ServerClosed, function(data){
			console.log('<···> ST Server.nodesControlService');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Server Closed');	// TODO OC REMOVE DEBUG LOG

		});

		this.nodesControlService.eventEmitter.on(this.nodesControlService.CONSTANTS.Events.NodeConnected, function(data){
			console.log('<···> ST Server.nodesControlService');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Events.NodeConnected');	// TODO OC REMOVE DEBUG LOG
		...
		this.nodesControlService.eventEmitter.on(this.nodesControlService.CONSTANTS.Events.NodeDisconnected, function(data){
			console.log('<···> ST Server.nodesControlService');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Events.NodeDisconnected');	// TODO OC REMOVE DEBUG LOG
		});
		...
		try {
			...
			console.log('Cannot start the service');	// TODO OC REMOVE DEBUG LOG
	...
	init_ServerControlService() {
		...
		this.serverControlService.eventEmitter.on(this.serverControlService.CONSTANTS.Events.ServerListening, function(data){
			console.log('<···> ST Server.serverControlService');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Server Listening');	// TODO OC REMOVE DEBUG LOG
		...
		this.serverControlService.eventEmitter.on(this.serverControlService.CONSTANTS.Events.ConfigError, function(data){
			console.log('<EEE> ST Server.serverControlService');	// TODO OC REMOVE DEBUG LOG
			console.log(' <···> Config Error');	// TODO OC REMOVE DEBUG LOG
