...
//			res.end();
		...
		this.expressRoute.get('/:sensorID/start', function(req, res) {
			...
			console.log(' <*> SeverControlService Sensor Start' );	// TODO OC REMOVE DEBUG LOG
			...
			try {
				...
				if (sensorSearch.stSensor != null ) {
					sensorSearch.stSensor.start().then(function(value) {
						...
						console.log(' <·> Sensor Started' );	// TODO OC REMOVE DEBUG LOG
					}, function(reason) {
		...
		this.expressRoute.get('/:sensorID/stop', function(req, res) {
			...
			console.log(' <*> SeverControlService Sensor Stop' );	// TODO OC REMOVE DEBUG LOG
			...
			try {
				...
				if (sensorSearch.stSensor != null ) {
					sensorSearch.stSensor.stop().then(function(value) {
						console.log( value );	// TODO OC REMOVE DEBUG LOG
						console.log(' <·> Sensor Stopped' );	// TODO OC REMOVE DEBUG LOG
					}, function(reason) {
		...
		this.expressRoute.get('/:nodeID/turnOffSensors', function(req, res) {
			...
			console.log(' <*> SeverControlService Sensors turnOffSensors' );	// TODO OC REMOVE DEBUG LOG
