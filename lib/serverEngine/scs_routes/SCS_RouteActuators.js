...
//			res.end();
		...
		this.expressRoute.get('/:actuatorID/start', function(req, res) {
			...
			console.log(' <*> SeverControlService Actuator Start' );	// TODO OC REMOVE DEBUG LOG
			...
			try {
				...
				if (actuatorSearch.stActuator != null ) {
					actuatorSearch.stActuator.start().then(function(value) {
						console.log( value );	// TODO OC REMOVE DEBUG LOG
						console.log(' <·> Actuator Started' );	// TODO OC REMOVE DEBUG LOG
					}, function(reason) {
		...
		this.expressRoute.get('/:actuatorID/stop', function(req, res) {
			...
			console.log(' <*> SeverControlService Actuator Stop' );	// TODO OC REMOVE DEBUG LOG
			...
			try {
				...
				if (actuatorSearch.stActuator != null ) {
					actuatorSearch.stActuator.stop().then(function(value) {
						console.log( value );	// TODO OC REMOVE DEBUG LOG
						console.log(' <·> Actuator Stopped' );	// TODO OC REMOVE DEBUG LOG
					}, function(reason) {
						console.log( reason );	// TODO OC REMOVE DEBUG LOG
		...
		this.expressRoute.get('/:nodeID/turnOffActuators', function(req, res) {
			...
			console.log(' <*> SeverControlService Actuators turnOffActuators' );	// TODO OC REMOVE DEBUG LOG
